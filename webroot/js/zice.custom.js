...
$(document).ready(function(){
	...
	if ($('#authMessage').hasClass('message')) {
		var str = $('#authMessage').html();
		$('#authMessage').html('');
		
		alertMessage("info", str);
	}
	...
	// Ajaxtabs
	$("ul.ajaxtabs li").fadeIn(400);
	//$("ul.ajaxtabs li:first").addClass("active").fadeIn(400);
	$("ul.ajaxtabs li").on('click',function() {
		$("ul.ajaxtabs li").removeClass("active");						   
