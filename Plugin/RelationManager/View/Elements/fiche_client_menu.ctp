...
$script = "
    ...
    function addrfact(){
        ...
        $('#getter').load('".$this->Html->url(array (
            ...
            'action' => 'get', $this->request->data['Client']['id'], 69
    ...
    function sitgeo(){
        ...
        $('#getter').load('".$this->Html->url(array (
            'controller' => 'client_datas',
            'action' => 'get', $this->request->data['Client']['id'], 70
        ))."', function(){unloading();}).fadeIn(400);
    }
    ...
    function tel(){
        ...
        $('#getter').load('".$this->Html->url(array (
            'controller' => 'client_datas',
            'action' => 'get', $this->request->data['Client']['id'], 71
        ))."', function(){unloading();}).fadeIn(400);
    }
    ...
    function cel(){
        ...
        $('#getter').load('".$this->Html->url(array (
            'controller' => 'client_datas',
            'action' => 'get', $this->request->data['Client']['id'], 72
        ))."', function(){unloading();}).fadeIn(400);
    }
    ...
    function fax(){
        ...
        $('#getter').load('".$this->Html->url(array (
            'controller' => 'client_datas',
            'action' => 'get', $this->request->data['Client']['id'], 73
        ))."', function(){unloading();}).fadeIn(400);
    }
    ...
    function email(){
        ...
        $('#getter').load('".$this->Html->url(array (
            'controller' => 'client_datas',
            'action' => 'get', $this->request->data['Client']['id'], 74
        ))."', function(){unloading();}).fadeIn(400);
    }
";
                            ...
                            <div>
                                <div class="ui-accordion ui-widget ui-helper-reset ui-accordion-icons">
                                    <h4 class="ui-accordion-header ui-helper-reset ui-state-default ui-corner-all">
                                        ...
                                        <a href="<?php echo $this->Html->url(array('action' => 'index')) ?>" id="clients">Gérer mes clients</a>
                                    </h4>
                                    <h4 class="ui-accordion-header ui-helper-reset ui-state-default ui-corner-all">
                                        <span class="ui-icon ui-icon-triangle-1-e"></span>
