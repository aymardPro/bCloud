...
$script = '
    $(document).ready(
    	function()
	    {
			...
			$("form#PaiementModaliteAddForm").validationEngine();
			
			$("form#PaiementModaliteAddForm").on(
	        	"submit",
	        	function()
	        	{
	        		loading("Loading");
...
<div class="formEl_b">
	<?php echo $this->Form->create('PaiementModalite', array('inputDefaults' => array('div' => false, 'label' => false))); ?>
			
			<div class="section">
				 <label for="PaiementModaliteName"> <?php echo __('Modalité') ?> <small><?php echo __('Entrez la modalité de paiement') ?></small></label>
				 <div>
