...
<?php echo $this->Form->create('FactureArticle'); ?>
	<fieldset>
		<legend><?php echo __('Edit Facture Article'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FactureArticle.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('FactureArticle.id'))); ?></li>
