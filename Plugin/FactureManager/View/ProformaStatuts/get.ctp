...
<h2>Liste des statuts (Proforma)</h2>
...
<table class="table<?php echo $bordered . $striped; ?> bcloud">
	...
	<tbody align="center">
		...
		<tr class="odd gradeX">
            <td class="left"> <?php echo h($data['ProformaStatut']['name']); ?> </td>
            <td class="center"> <?php echo $data['ProformaStatut']['id']; ?> </td>
			<td>
				<?php
				echo $this->Form->postLink(
    				$this->Html->image('/images/icon/coquette-icons-set/16x16/delete.png'),
    				array('action' => 'delete', $data['ProformaStatut']['id']),
    				array('escape' => false, 'confirm' => __('Voulez-vous supprimer définitivement %s ?', $data['ProformaStatut']['name']))
    			);
				?>
			</td>
		</tr>
